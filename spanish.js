...
class ScrabbleGame {
	...
	checkAIMoveValidity(word, startPos, isHorizontal) {
		// List of variant spellings or non-Spanish words to exclude
		const excludedVariants = new Set([
			"atropin", // German spelling, not valid in Spanish Scrabble
...
formedWords.forEach((wordInfo) => {
	...
	async loadDictionary() {
		...
		this.dictionary = new Set([
			...
			"anubecerse", "anubicar", "anuencia", "anuel", "anuencia", "anuencia", "anuencia", "anuencia", "anuencia", "anuencia", "anuencia", "anuencia",
			"anudación", "anuladizo", "anuladamente", "anuladamente", "anuladamente", "anuladamente", "anuladamente", "anuladamente", "anuladamente", "anuladamente",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"anulación", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			...
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura", "anulador", "anuladora", "anuladura",
			"abrazo", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura", "abrazador", "abrazadora", "abrazadura",
			"abr", "abre", "abrelata", "abrelatas", "abrelatas", "abrelatas", "abrelatas", "abrelatas", "abrelatas", "abrelatas", "abrelatas", "abrelatas",
			"abrelatador", "abrelatadora", "abrelatadura", "abrelatador", "abrelatadora", "abrelatadura", "abrelatador", "abrelatadora", "abrelatadura", "abrelatador", "abrelatadora", "abrelatadura",
			"abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio", "abrenuncio",
...
calculateScore() {
	...
	speakBingo(source = 'player') {
		try {
			...
			try {
				this._speakWithRetry('Bingo bonus!', { lang: 'es-ES', rate: 1.15, pitch: 1.4 }).catch(e => {
	...
	// Pick a preferred Spanish voice if available. Returns a SpeechSynthesisVoice or null.
	_getPreferredVoice() {
		try {
			if (typeof window === 'undefined' || !('speechSynthesis' in window)) return null;
			const voices = window.speechSynthesis.getVoices() || [];
			if (!voices || voices.length === 0) return null;
			// Prefer explicit Spanish voices (es-ES/es-MX) and prefer female-like names if present
			let pick = null;
			for (const v of voices) {
				if (!v.lang) continue;
				const lang = v.lang.toLowerCase();
				if (lang.startsWith('es') && (!pick || v.name.toLowerCase().includes('female') || v.name.toLowerCase().includes('female'))) {
					pick = v;
				}
			}
			if (!pick) pick = voices.find(v => v.lang && v.lang.toLowerCase().startsWith('es')) || voices[0];
			return pick || null;
		} catch (e) {
						...
						setTimeout(async () => {
							try {
								...
								if (!window.speechSynthesis.pending && !window.speechSynthesis.speaking) {
									...
									for (let t of texts) {
										try { await this._speakWithRetry(t, { lang: 'es-ES' }); } catch (e) { /* ignore */ }
									}
		...
		return new Promise(async (resolve) => {
			try {
				...
				for (let idx = 0; idx < words.length; idx++) {
					...
					try {
						await this._speakWithRetry(text, { lang: 'es-ES' });
					} catch (e) {
								...
								while (attempt <= maxRetries && !success) {
									...
									try {
										...
										if (!(typeof window !== 'undefined' && 'speechSynthesis' in window && (window.speechSynthesis.speaking || window.speechSynthesis.pending))) {
											await this._speakWithRetry('Bingo bonus!', { lang: 'es-ES' });
										}
	...
	createMoveHistoryDisplay() {
		...
		if (mobileDrawer) {
			...
			if (!consoleBox) {
				...
				consoleBox.innerHTML = '<div style="display:flex;align-items:center;justify-content:space-between"><strong>' + (typeof t === 'function' ? t('console') : 'Consola') + '</strong><button class="copy-console-btn" style="font-size:12px;padding:4px 6px;border-radius:4px">' + (typeof t === 'function' ? t('copy-all') : 'Copiar Todo') + '</button></div><div class="console-entries" style="margin-top:6px;font-family:monospace"></div>';
	...
	try {
		...
		if (mobileDrawer) {
			...
			if (!consoleContainer) {
				...
				title.textContent = typeof t === 'function' ? t('console') : 'Consola';
				title.style.fontWeight = '600';
				title.style.color = '#123';

				const copyBtn = document.createElement('button');
				copyBtn.textContent = typeof t === 'function' ? t('copy-all') : 'Copiar Todo';
