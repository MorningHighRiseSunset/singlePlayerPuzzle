...
class ScrabbleGame {
	constructor() {
		this.board = Array(15)
		   ...
		   this.tileValues = {
			   'अ': 1, 'आ': 1, 'इ': 1, 'ई': 2, 'उ': 1, 'ऊ': 2, 'ए': 1, 'ऐ': 2, 'ओ': 1, 'औ': 2,
			   'क': 2, 'ख': 3, 'ग': 2, 'घ': 4, 'च': 2, 'छ': 4, 'ज': 2, 'झ': 5, 'ट': 3, 'ठ': 5,
			   'ड': 3, 'ढ': 5, 'त': 1, 'थ': 3, 'द': 1, 'ध': 3, 'न': 1, 'प': 2, 'फ': 4, 'ब': 2,
			   'भ': 4, 'म': 2, 'य': 2, 'र': 1, 'ल': 1, 'व': 2, 'श': 3, 'ष': 4, 'स': 1, 'ह': 2,
			   'ळ': 5, 'क्ष': 8, 'ज्ञ': 8, ' ': 0, '*': 0
		   };
		   this.tileDistribution = {
			   'अ': 8, 'आ': 6, 'इ': 5, 'ई': 4, 'उ': 5, 'ऊ': 3, 'ए': 4, 'ऐ': 2, 'ओ': 4, 'औ': 2,
			   'क': 5, 'ख': 2, 'ग': 4, 'घ': 2, 'च': 4, 'छ': 2, 'ज': 4, 'झ': 1, 'ट': 2, 'ठ': 1,
			   'ड': 2, 'ढ': 1, 'त': 6, 'थ': 2, 'द': 4, 'ध': 2, 'न': 6, 'प': 4, 'फ': 2, 'ब': 4,
			   'भ': 2, 'म': 4, 'य': 3, 'र': 6, 'ल': 5, 'व': 3, 'श': 3, 'ष': 2, 'स': 5, 'ह': 3,
			   'ळ': 1, 'क्ष': 1, 'ज्ञ': 1, '*': 2
		   };
	...
	async getWordDefinition(word) {
		const definition = await fetchWordDefinition(word, "hi");
...
formedWords.forEach((wordInfo) => {
	...
	async loadDictionary() {
		...
		try {
			...
			'कपड़ा', 'जूता', 'टोपी', 'कमीज़', 'पैंट', 'साड़ी', 'कोट', 'छाता', 'किताब', 'कलम', 'कागज़', 'पेंसिल',
			'कार', 'ट्रेन', 'बस', 'रेल', 'सड़क', 'गली', 'सेतु', 'पुल', 'स्कूल', 'शिक्षक', 'छात्र', 'परीक्षा',
			'माता', 'पिता', 'भाई', 'बहन', 'दादा', 'दादी', 'नाना', 'नानी', 'प्यार', 'दोस्त', 'दुश्मन',
			'दिन', 'रात', 'सुबह', 'शाम', 'दोपहर', 'जनवरी', 'फरवरी', 'मार्च', 'अप्रैल', 'मई', 'जून', 'जुलाई',
			'अगस्त', 'सितंबर', 'अक्टूबर', 'नवंबर', 'दिसंबर', 'सोमवार', 'मंगलवार', 'बुधवार', 'गुरुवार', 'शुक्रवार', 'शनिवार', 'रविवार',
			'बड़ा', 'छोटा', 'लंबा', 'मोटा', 'काला', 'सफेद', 'लाल', 'हरा', 'नीला', 'पीला', 'गर्म', 'ठंडा',
			'में', 'पर', 'के', 'को', 'से', 'तक', 'बिना', 'साथ', 'बीच', 'पास', 'दूर', 'नमस्ते',
			'हां', 'नहीं', 'क्या', 'कौन', 'कब', 'कहां', 'क्यों', 'कैसे', 'भारत', 'दिल्ली', 'मुंबई', 'बेंगलुरु',
			'चेन्नै', 'कोलकाता', 'पुणे', 'हैदराबाद', 'गंगा', 'यमुना', 'ब्रह्मपुत्र', 'सतलुज', 'सिंधु', 'महानदी', 'नर्मदा', 'गोदावरी',
			'कृष्णा', 'कावेरी', 'हिमालय', 'विंध्य', 'सतपुड़ा', 'पश्चिमघाट', 'पूर्वघाट', 'मैदान', 'पठार', 'तटीय', 'द्वीप', 'झील',
			'जल', 'धरती', 'आकाश', 'सूरज', 'चांद', 'तारा', 'बादल', 'बिजली', 'गड़गड़ाहट', 'बारिश', 'हिम', 'बर्फ',
			'हवा', 'वायु', 'आग', 'आग्नि', 'अग्नि', 'पृथ्वी', 'जीवन', 'मृत्यु', 'जन्म', 'उम्र', 'समय', 'काल',
			'स्वास्थ्य', 'बीमारी', 'दर्द', 'खांसी', 'जुकाम', 'बुखार', 'चिकित्सक', 'डॉक्टर', 'दवा', 'औषधि', 'अस्पताल', 'वैद्य',
			'आनंद', 'खुशी', 'दुःख', 'क्रोध', 'गुस्सा', 'भय', 'डर', 'लज्जा', 'शर्म', 'गर्व', 'अहंकार',
			'आशा', 'निराशा', 'हतास', 'उम्मीद', 'विश्वास', 'अविश्वास', 'संदेह', 'शक', 'विज्ञान', 'गणित', 'भाषा', 'साहित्य',
			'इतिहास', 'भूगोल', 'कला', 'संगीत', 'नृत्य', 'नाटक', 'खेल', 'क्रिकेट', 'फुटबॉल', 'हॉकी', 'टेनिस', 'बैडमिंटन',
			'कबड्डी', 'कुश्ती', 'दौड़', 'तैराकी', 'मुक्केबाजी', 'तलवारबाजी', 'तीरंदाजी', 'निशानेबाजी', 'जिमनास्टिक्स', 'बास्केटबॉल', 'वॉलीबॉल', 'बेसबॉल',
			'कवि', 'लेखक', 'कहानी', 'कविता', 'उपन्यास', 'नाटक', 'फिल्म', 'गीत', 'गाना', 'संगीतकार', 'गायक', 'गायिका',
			'भोजन', 'भात', 'दाल', 'सब्जी', 'मेवा', 'मीठा', 'मिठाई', 'नमकीन', 'खीर', 'हलवा', 'लड्डू', 'गुलाब जामुन',
			'जलेबी', 'बर्फी', 'पेड़े', 'मालपुए', 'राजस्थानी गुझिया', 'भारतीय', 'अंग्रेजी', 'हिंदी', 'संस्कृत', 'तमिल', 'तेलुगु',
			'कन्नड़', 'मलयालम', 'गुजराती', 'मराठी', 'बंगाली', 'उड़िया', 'पंजाबी', 'कश्मीरी', 'सिंधी', 'असमिया', 'मणिपुरी',
			'राजा', 'रानी', 'राजकुमार', 'राजकुमारी', 'शासक', 'राज्य', 'साम्राज्य', 'युद्ध', 'लड़ाई', 'सेना', 'सैनिक', 'जनरल',
			'शांति', 'संधि', 'समझौता', 'नियम', 'कानून', 'न्याय', 'अधिकार', 'कर्तव्य', 'जिम्मेदारी', 'दायित्व', 'उत्तरदायित्व', 'जवाबदेही',
			'धर्म', 'पाप', 'पुण्य', 'कर्म', 'ज्ञान', 'अज्ञान', 'सत्य', 'असत्य', 'झूठ', 'सच', 'विश्वास', 'अविश्वास',
			'ईश्वर', 'देव', 'देवी', 'भगवान', 'देवता', 'पूजा', 'प्रार्थना', 'आरती', 'मंदिर', 'मस्जिद', 'चर्च', 'गिरिजाघर',
			'गुरुद्वारा', 'धार्मिक', 'पवित्र', 'पवित्रता', 'पूण्य', 'अपवित्र', 'अशुद्ध', 'अपवित्रता', 'त्योहार', 'दिवाली', 'होली', 'ईद',
			'क्रिसमस', 'ईस्टर', 'जन्माष्टमी', 'रक्षाबंधन', 'नवरात्र', 'दशहरा', 'दुर्गा', 'शिव', 'ब्रह्मा', 'विष्णु', 'हनुमान', 'गणेश',
			'लक्ष्मी', 'सरस्वती', 'काली', 'सीता', 'राधा', 'कृष्ण', 'राम', 'पार्वती', 'देश', 'राष्ट्र', 'राष्ट्रीय', 'स्वतंत्रता',
			'आजादी', 'स्वतंत्र', 'पराधीन', 'गुलामी', 'स्वाधीनता', 'हिंदुस्तान', 'संविधान', 'लोकतंत्र', 'जनतंत्र', 'गणतंत्र', 'राजतंत्र', 'संसद',
			'मंत्रिमंडल', 'राष्ट्रपति', 'प्रधानमंत्री', 'मुख्यमंत्री', 'राज्यपाल', 'पार्षद', 'राज्य', 'जिला', 'तहसील', 'पंचायत', 'सरपंच', 'नगर',
			'नगरपालिका', 'महापालिका', 'नगरसभा', 'लोकसभा', 'राज्यसभा', 'काम', 'व्यवसाय', 'नौकरी', 'व्यापार', 'व्यवहार', 'वेतन', 'मजदूरी',
			'कमाना', 'खर्चा', 'बचत', 'निवेश', 'लाभ', 'हानि', 'मुनाफा', 'घाटा', 'पैसा', 'रुपया', 'पैसे', 'सिक्का', 'नोट',
			'मुद्रा', 'बैंक', 'खाता', 'जमा', 'निकासी', 'ब्याज', 'कर', 'टैक्स', 'आयकर', 'बिक्रय कर', 'आबकारी', 'वाणिज्य',
			'बाजार', 'दुकान', 'दुकानदार', 'व्यापारी', 'विक्रेता', 'खरीददार', 'ग्राहक', 'लेनदार', 'कर्जदार', 'साहूकार', 'सूदखोर', 'भिखारी',
			'किसान', 'खेती', 'खेत', 'फसल', 'बीज', 'बोना', 'कटना', 'काटना', 'सिंचाई', 'हल', 'गहाई', 'दहाई', 'पिसाई',
			'गेहूं', 'चावल', 'गन्ना', 'कपास', 'जूट', 'तंबाकू', 'सरसों', 'मूंगफली', 'सूरजमुखी', 'अलसी', 'मेंथा', 'इलायची',
			'हल्दी', 'काली मिर्च', 'लाल मिर्च', 'लौंग', 'दालचीनी', 'जायफल', 'जावित्री', 'पशु', 'पक्षी', 'मछली', 'गाय', 'भैंस',
			'बकरी', 'भेड़', 'घोड़ा', 'गधा', 'ऊंट', 'हाथी', 'शेर', 'बाघ', 'चीता', 'भालू', 'लोमड़ी', 'भेड़िया', 'जैकाल',
			'लकड़बग्घा', 'खरगोश', 'गिलहरी', 'बंदर', 'बिल्ली', 'कुत्ता', 'पिल्ला', 'सांप', 'बिच्छू', 'छिपकली', 'कछुआ', 'मेंढक',
			'तोता', 'कौआ', 'कबूतर', 'चिड़िया', 'बाज', 'उल्लू', 'कोयल', 'गौरैया', 'बुलबुल', 'फाख्ता', 'मैना', 'तिहरी',
			'ट्रेन', 'ड्राइवर', 'कंडक्टर', 'स्टेशन', 'प्लेटफॉर्म', 'टिकट', 'किराया', 'सामान', 'डिब्बा', 'इंजन', 'पहिया', 'पटरी',
			'पुल', 'सुरंग', 'क्रॉसिंग', 'सिगनल', 'स्टेशन मास्टर', 'यार्ड', 'डिपो', 'वर्कशॉप', 'मेकैनिक', 'फिटर', 'वेल्डर', 'इलेक्ट्रीशियन',
			'नर्स', 'डॉक्टर', 'सर्जन', 'दंत चिकित्सक', 'नेत्र चिकित्सक', 'कान नाक गला विशेषज्ञ', 'त्वचा रोग विशेषज्ञ', 'मनोचिकित्सक', 'बाल रोग विशेषज्ञ', 'स्त्री रोग विशेषज्ञ',
			'गर्भवती', 'प्रसव', 'बेबी', 'शिशु', 'नवजात', 'स्तनपान', 'ढोलकी', 'दवा खाना', 'इंजेक्शन', 'ऑपरेशन', 'थेरेपी', 'पुनर्वास',
			'फिजियोथेरेपी', 'योग', 'ध्यान', 'व्यायाम', 'डाइट', 'पोषण', 'विटामिन', 'मिनरल', 'प्रोटीन', 'कार्बोहाइड्रेट', 'फैट', 'फाइबर',
			'कोलेस्ट्रॉल', 'ब्लड प्रेशर', 'डायबिटीज', 'हृदय रोग', 'कैंसर', 'दमा', 'टीबी', 'एचआईवी', 'वायरस', 'बैक्टीरिया', 'संक्रमण', 'इम्यून सिस्टम',
			'एंटीबॉडी', 'एंटीजन', 'टीका', 'टीकाकरण', 'टेस्ट', 'रिपोर्ट', 'प्रिस्क्रिप्शन', 'दवाई', 'औषधि', 'दुष्प्रभाव', 'साइड इफेक्ट', 'एलर्जी',
			'खुजली', 'त्वचा रोग', 'घाव', 'सूजन', 'अल्सर', 'गैस्ट्राइटिस', 'अपच', 'कब्ज', 'दस्त', 'पेचिश', 'हैजा', 'कॉलेरा',
			'बुखार', 'सर्दी', 'खांसी', 'गले में खराश', 'लैरिंजाइटिस', 'ब्रोंकाइटिस', 'निमोनिया', 'तपेदिक', 'खसरा', 'चेचक', 'पोलियो', 'काली खांसी',
...
calculateScore() {
	...
	updateMoveHistory() {
		...
		const t = (key) => {
			// Use Hindi translation if available
			if (window.language === 'hi' && window.translations && window.translations.hi && window.translations.hi[key]) {
				return window.translations.hi[key];
			}
			// Fallback to English
		...
		const historyContent = `<h3>${t('definitions-history')}</h3>` +
			...
			.map((move) => {
				...
				// Special case: "AI decided to exchange their tiles." message
				if (move.word && move.word.includes("exchange")) {
					return `<div class="move">${playerLabel(move.player)}: ${t('move-exchange')}</div>`;
				}
				...
				// Unknown format
				return `<div class="move">${playerLabel(move.player)}: (चाल) ${t('scores').toLowerCase()}: ${move.score}</div>`;
			})
			.join("");
